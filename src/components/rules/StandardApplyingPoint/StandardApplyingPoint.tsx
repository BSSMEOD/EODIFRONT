...
const StandardApplyingPoint = ({ id }: StandardApplyingPointProps) => {
  return (
    <StyledStandardApplyingPoint id={id}>
      ...
      <Description>상점 1점은 벌점 1점을 상쇄 가능하다. </Description>
      <br />
      <TextBox>
        <Description>
          ...
          <br />- 벌점 누적 15점 이상 : 생활교육위원회* 진행
        </Description>
        <Description>
          *생활교육위원회에서는 다음을 결정한다. <br />
          학년 부 자체 해결
          <br />
          선도위원회 개최
          <br />
      ...
      <Description>
        ...
        수 있다. 매 학년도 상벌점제 누가기록을 마이스터고 역량 인증제에
        반영한다. 매 학년도 3월에 전 학년도의 상벌점 누계는 0점으로 처리한다.
      </Description>
